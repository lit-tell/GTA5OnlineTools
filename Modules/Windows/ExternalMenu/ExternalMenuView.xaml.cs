...
namespace GTA5OnlineTools.Modules.Windows.ExternalMenu
{
    ...
    public partial class ExternalMenuView : Window
    {
        ...
        private void CreateMenuBar()
        {
            ...
            MenuBars.Add(new MenuBar() { Icon = "\xe6ff", Title = "刷载具", ColorHex = "#333333", NameSpace = "EM1SpawnVehicleView" });
            MenuBars.Add(new MenuBar() { Icon = "\xe6ff", Title = "刷武器", ColorHex = "#333333", NameSpace = "EM2SpawnWeaponView" });
