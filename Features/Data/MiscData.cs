namespace GTA5OnlineTools.Features.Data
{
    public class MiscData
    {
        ...
        {
            new CEOCargo(){ Name = "医疗用品 (无特殊物品)", ID = 0 },
            new CEOCargo(){ Name = "烟酒 (无特殊物品)", ID = 1 },
            new CEOCargo(){ Name = "古董艺术品 (华丽彩蛋)", ID = 2 },
            new CEOCargo(){ Name = "电子产品 (无特殊物品)", ID = 3 },
            new CEOCargo(){ Name = "武器弹药 (黄金火神机枪)", ID = 4 },
            new CEOCargo(){ Name = "迷幻药 (无特殊物品)", ID = 5 },
            ...
            new CEOCargo(){ Name = "银块 (无特殊物品)", ID = 10 },
        };

        public class MerryweatherService
        {
            public string Name { get; set; }
            public int ID { get; set; }
        }
