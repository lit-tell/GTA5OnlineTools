...
public class Offsets
{
    public class Mask
    {
        ...
        public const string WorldPTR = "48 8B 05 ?? ?? ?? ?? 45 ?? ?? ?? ?? 48 8B 48 08 48 85 C9 74 07";
        public const string BlipPTR = "4C 8D 05 ?? ?? ?? ?? 0F B7 C1";
        public const string GlobalPTR = "4C 8D 05 ?? ?? ?? ?? 4D 8B 08 4D 85 C9 74 11";

        public const string PlayerListPTR = "48 8B 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8B C8 E8 ?? ?? ?? ?? 48 8B CF";
        public const string ReplayInterfacePTR = "48 8D 0D ?? ?? ?? ?? 48 8B D7 E8 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? 8A D8 E8";
        public const string AimingPedPTR = "48 8B 0D ?? ?? ?? ?? 48 85 C9 74 0C 48 8D 15 ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 89 1D";

        public const string ViewPortPTR = "48 8B 15 ?? ?? ?? ?? 48 8D 2D ?? ?? ?? ?? 48 8B CD";
        public const string CCameraPTR = "48 8B 05 ?? ?? ?? ?? 4A 8B 1C F0";

        public const string WeatherPTR = "48 83 EC ?? 8B 05 ?? ?? ?? ?? 8B 3D ?? ?? ?? ?? 49";

        public const string FriendList = "48 8B 0D ?? ?? ?? ?? 8B C6 48 8D 5C 24 70";
        public const string PickupData = "48 8B 05 ?? ?? ?? ?? 48 8B 1C F8 8B";
        public const string UnkModel = "4C 8B 15 ?? ?? ?? ?? 49 8B 04 D2 44 39 40 08";

        public const string PlayerNameChatPTR = "48 8D 0D ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8D 0D ?? ?? ?? ?? 83";

        public const string FrameFlagsZeroWriteCall = "48 81 C1 ?? ?? ?? ?? E8 ?? ?? ?? ?? 48 8B 5C 24 ?? 0F 28 74 24 ??";
    }
