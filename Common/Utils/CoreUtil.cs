...
namespace GTA5OnlineTools.Common.Utils
{
    public class CoreUtil
    {
        ...
        /// 主窗口标题
        /// </summary>
        public const string MainAppWindowName = "GTA5线上小助手 支持1.58 完全免费 v";
        ...
        // 小助手配置文件
        public const string ConfigAddress = "https://crazyzhang.neocities.org/GTA5OnlineTools/Config.json";

        public static string ChangeAddress = "https://crazyzhang.neocities.org/GTA5OnlineTools/Server/Change.txt";
        public static string NoticeAddress = "https://crazyzhang.neocities.org/GTA5OnlineTools/Server/Notice.txt";
